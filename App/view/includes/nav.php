        ...
        <?php if (isset($_SESSION['user'])): ?>
            ...
            <div class="collapse navbar-collapse" id="nav_lc">
                <ul class="d-none d-lg-flex navbar-nav mx-auto my-3 my-lg-0 position-absolute top-50 start-50 translate-middle">
                    ...
                    <li class="nav-item me-4"><a class="nav-link" href="/brief10/public/index.php/about">Dashboard</a></li>
                    <li class="nav-item"><a class="nav-link" href="/brief10/public/index.php/product">Profile</a></li>
                </ul>
